		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							<li><i class="fa fa-dashboard"></i> <a href="${context}/index"><span><lebel>Instance Details..</lebel></span></a>
							</li>
						</ol>
					</div>
				</div>
					...
					<table cellpadding="10" class="table table-striped">
						...
						<c:forEach var="instance_list" items="${instance_list}">
							<tr>
								...
								<td><a href="${context}/cloudwatch/${instance_list.getName()}">${instance_list.getName()}</td>
